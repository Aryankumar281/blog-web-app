    ...
    return (
        <Box>
            ...
            <Wrapper>
                ...
                <Text variant="h5">Welcome to NODEFARM, your go-to destination for insightful and engaging blog content. We're passionate about creating a platform where ideas, stories, and opinions can be shared, discussed, and celebrated.
